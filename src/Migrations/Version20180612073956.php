 ...
 */
final class Version20180612073956 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comanda CHANGE product_id product_id INT DEFAULT NULL, CHANGE technician_id technician_id INT DEFAULT NULL, CHANGE status status TINYINT(1) DEFAULT NULL, CHANGE total total DOUBLE PRECISION DEFAULT NULL, CHANGE time time INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comanda CHANGE product_id product_id INT DEFAULT NULL, CHANGE technician_id technician_id INT DEFAULT NULL, CHANGE status status TINYINT(1) DEFAULT \'NULL\', CHANGE total total DOUBLE PRECISION NOT NULL, CHANGE time time INT NOT NULL');
