 ...
 */
final class Version20180611182525 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comanda ADD total DOUBLE PRECISION NOT NULL, CHANGE product_id product_id INT DEFAULT NULL, CHANGE technician_id technician_id INT DEFAULT NULL, CHANGE status status TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comanda DROP total, CHANGE product_id product_id INT DEFAULT NULL, CHANGE technician_id technician_id INT DEFAULT NULL, CHANGE status status TINYINT(1) DEFAULT \'NULL\'');
